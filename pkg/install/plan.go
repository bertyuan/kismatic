...
var commentMap = map[string]string{
	...
	"add_ons.cni.provider":                               "Options: 'calico','weave','contiv','custom'. Selecting 'custom' will configure the cluster to be CNI ready, but it is up to you to install the desired solution after.",
